...
class Background3():
    ...
    def load_content(self) -> None: # Load once
        ...
        self.imgWidth = (sprites.img_2background1.get_width())-self.adjust # the image widht with adjustment
        self.images = [sprites.img_2background1, sprites.img_2background2,
                      sprites.img_2background3, sprites.img_2background4,
                     sprites.img_2background5] # all the sprites in a list 
